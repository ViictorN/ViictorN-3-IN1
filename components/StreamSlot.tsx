...
const StreamSlot: React.FC<StreamSlotProps> = ({ streamer, currentPlatform, onPlatformChange }) => {
  ...
  return (
    <div className="relative w-full h-full bg-black overflow-hidden group">
      ...
      {/* Explicit pointer-events-auto to ensure interactivity */}
      {channelId ? (
        <iframe
      ...
      {/* 2. HUD ELEMENTS - INDIVIDUALLY POSITIONED (Z-10) */}
      {/* We DO NOT use a full-screen wrapper here to avoid any overlay issues */}
      ...
      <div className="absolute top-4 right-4 z-10 flex gap-2">
          ...
          <button
              ...
              className="w-8 h-8 flex items-center justify-center rounded-full bg-black/40 backdrop-blur-md border border-white/10 text-white/50 hover:text-white hover:bg-white/10 transition-colors cursor-pointer"
            ...
            <div className="relative p-6 flex flex-col items-center justify-center h-full pointer-events-none">
              <div className="pointer-events-auto flex flex-col items-center">
                  ...
                  />
                   ...
                   <button 
                    onClick={() => setShowControls(false)}
                    className="mt-8 p-2 text-white/30 hover:text-white transition-colors rounded-full cursor-pointer"
                  >
